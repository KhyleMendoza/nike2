...
function showModal(item) {
  ...
  modalBody.innerHTML = `
    ...
    <p id="price"><strong>Price:</strong> $${item.price}</p>
    <p id="rating"><strong>Rating:</strong> ${item.rating}</p>
    <p id="description"><strong>Description:</strong> ${item.description}</p>
